...
public class RecyclerViewAdapterForSale extends RecyclerView.Adapter<RecyclerViewAdapterForSale.ViewHolder> {
    ...
    public RecyclerViewAdapterForSale(ArrayList<String> item_desc, ArrayList<String> item_desc2, ArrayList<String> item_name, ArrayList<String> item_name2, ArrayList<Integer> img_path, Context mContext) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.dislike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                helperFunctions.onDislikeButtonPressed(mContext, position);
            }
        });
        holder.lay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                helperFunctions.onForSaleItemPressed(mContext, position);
            }
        });
    }
    @Override
